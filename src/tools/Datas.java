...
public class Datas {
    ...
    private static String IdPresence;
    private static String IdOvertime;
    private static String isDelete;

    public static String getIsDelete() {
        return isDelete;
    }

    public static void setIsDelete(String isDelete) {
        Datas.isDelete = isDelete;
    }

    public static String getIdOvertime() {
        return IdOvertime;
    }

    public static void setIdOvertime(String IdOvertime) {
        Datas.IdOvertime = IdOvertime;
    }
    ...
    public static void setIdPresence(String IdPresence) {
        Datas.IdPresence = IdPresence;
    }
    
    public static String getIdPresence(){
        return IdPresence;
    }
